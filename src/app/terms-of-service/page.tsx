...
export const metadata: Metadata = {
  ...
  description:
    "Murphy's Turf terms of service. Review the terms and conditions governing your use of our lawn care and turf cleaning services in Colorado.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10">
            <p className="text-charcoal font-body text-base leading-relaxed mb-4">
              ...
              related offerings provided by Murphy&apos;s Turf LLC, a Colorado limited liability
          ...
          <div className="space-y-12">
            ...
            <div id="services-description">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                Murphy&apos;s Turf LLC provides professional lawn care and turf cleaning services
                throughout the State of Colorado, with a primary focus on the Front Range region. Our
            ...
            <div id="pricing-payment">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                ...
                permitted by Colorado law, whichever is less. Murphy&apos;s Turf LLC reserves the
            ...
            <div id="limitation-liability">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                ...
                that cannot be lawfully excluded or limited under applicable Colorado or federal law.
              </p>
            </div>
            ...
            <div id="governing-law">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                ...
                accordance with the laws of the State of Colorado, without regard to its conflict of
                law provisions.
              </p>
              <p className="text-charcoal font-body text-base leading-relaxed">
                Any legal action or proceeding arising under these Terms shall be brought exclusively
                in the state or federal courts located in Denver County, Colorado, and you hereby
            ...
            <div id="dispute-resolution">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                Please contact us directly by phone at (720) 555-1234 or by email at{' '}
                <a
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                ...
                mutually agreed-upon mediator in Denver, Colorado. The costs of mediation shall be
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                ...
                Association. Arbitration shall take place in Denver, Colorado, and shall be conducted
            ...
            <div id="contact">
              ...
              <div className="bg-cream rounded-xl p-6 sm:p-8 border border-cream-dark">
                ...
                <div className="text-charcoal font-body text-base leading-relaxed space-y-2">
                  ...
                  <p>
                    <strong>Business Hours:</strong> Monday through Friday, 7:00 AM to 6:00 PM MST;
