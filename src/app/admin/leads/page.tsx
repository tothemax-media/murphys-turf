...
const SAMPLE_LEADS: Lead[] = [
  {
    ...
    phone: '(303) 555-0142',
    address: '4821 Maple St, Denver, CO 80220',
    service: 'Lawn Mowing',
    status: 'New',
    date: '2026-03-19',
    source: 'Website',
  ...
  },
  {
    ...
    phone: '(720) 555-0198',
    address: '1230 Elm Ave, Aurora, CO 80012',
  ...
  },
  {
    ...
    phone: '(303) 555-0267',
    address: '782 Birch Ln, Lakewood, CO 80226',
    service: 'Aeration',
    status: 'Qualified',
    date: '2026-03-17',
    source: 'Referral',
  ...
  },
  {
    ...
    phone: '(720) 555-0334',
    address: '3455 Oak Blvd, Centennial, CO 80122',
    service: 'Landscaping',
    status: 'Converted',
    date: '2026-03-10',
    source: 'Website',
  ...
  },
  {
    ...
    phone: '(303) 555-0411',
    address: '910 Pine Ridge Dr, Highlands Ranch, CO 80129',
  ...
  },
  {
    ...
    phone: '(720) 555-0589',
    address: '6671 Aspen Way, Littleton, CO 80123',
    service: 'Sod Installation',
    status: 'Contacted',
    date: '2026-03-16',
    source: 'Facebook',
    message: 'Need about 2,000 sq ft of Kentucky Bluegrass sod installed in the backyard. Old lawn died last summer.',
  ...
  },
  {
    ...
    phone: '(303) 555-0623',
    address: '2245 Spruce Ct, Arvada, CO 80003',
    service: 'Lawn Mowing',
    status: 'Lost',
    date: '2026-03-08',
    source: 'Google Ads',
  ...
  },
  {
    ...
    phone: '(720) 555-0756',
    address: '1188 Cedar Park Rd, Westminster, CO 80031',
    service: 'Fertilization',
    status: 'New',
    date: '2026-03-20',
    source: 'Website',
  ...
  },
  {
    ...
    phone: '(303) 555-0891',
    address: '5590 Willow Creek Blvd, Parker, CO 80134',
    service: 'Landscaping',
    status: 'Qualified',
    date: '2026-03-14',
    source: 'Referral',
  ...
  },
  {
    ...
    phone: '(720) 555-0944',
    address: '3312 Cottonwood Ln, Thornton, CO 80229',
    service: 'Aeration',
    status: 'Converted',
    date: '2026-03-06',
    source: 'Google Ads',
  ...
  },
  {
    ...
    phone: '(303) 555-1078',
    address: '7743 Dogwood St, Broomfield, CO 80020',
    service: 'Sprinkler Repair',
    status: 'Contacted',
    date: '2026-03-15',
    source: 'NextDoor',
  ...
  },
  {
    ...
    phone: '(720) 555-1135',
    address: '4401 Juniper Hill Dr, Castle Rock, CO 80104',
    service: 'Sod Installation',
    status: 'Lost',
    date: '2026-03-05',
    source: 'Website',
  ...
  },
  {
    ...
    phone: '(303) 555-1267',
    address: '1925 Redwood Pl, Englewood, CO 80110',
    service: 'Lawn Mowing',
    status: 'New',
    date: '2026-03-20',
    source: 'Yelp',
  ...
  },
  {
    ...
    phone: '(720) 555-1399',
    address: '8860 Magnolia Dr, Commerce City, CO 80022',
    service: 'Landscaping',
    status: 'Qualified',
    date: '2026-03-13',
    source: 'Facebook',
  ...
  },
  {
    ...
    phone: '(303) 555-1452',
    address: '6209 Hickory Rd, Golden, CO 80401',
    service: 'Fertilization',
    status: 'Contacted',
    date: '2026-03-12',
    source: 'Google Ads',
  ...
  },
  {
    ...
    phone: '(720) 555-1588',
    address: '2780 Sycamore Ave, Lone Tree, CO 80124',
    service: 'Sprinkler Repair',
    status: 'Converted',
    date: '2026-03-09',
    source: 'Referral',
    message: 'Need a full sprinkler system audit and winterization blowout scheduling for next fall.',
    notes: 'Audit completed 3/15. Found 4 issues. Repair + fall contract signed. Total: $1,850.',
  },
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-[#5D4037] text-sm">
            Manage and track incoming lawn care service inquiries across the Denver metro area.
          </p>
        </div>
